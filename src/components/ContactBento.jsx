    ...
    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
      ...
      <div className="md:col-span-7 bento-card rounded-2xl p-6 sm:p-8 flex flex-col justify-between space-y-6">
        <div>
          ...
          <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-zinc-950 dark:text-white mt-1">
            Get in touch
          </h2>
          <p className="text-xs sm:text-sm text-zinc-600 dark:text-zinc-300 mt-2 leading-relaxed font-normal">
        ...
        <div className="space-y-2.5 font-mono text-xs">
          <div className="flex items-center justify-between p-3.5 rounded-xl bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800 hover:border-teal-400 dark:hover:border-teal-600 hover:bg-teal-50/20 dark:hover:bg-teal-950/20 transition-all shadow-2xs">
            <div className="flex items-center gap-2.5 text-zinc-800 dark:text-zinc-200 font-medium">
            ...
            <button
              onClick={copyEmail}
              className="px-3 py-1 rounded-md bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:border-teal-500 hover:text-teal-700 dark:hover:text-teal-300 text-zinc-700 dark:text-zinc-300 transition-all flex items-center gap-1 text-[11px] shadow-2xs font-semibold"
            >
              {copiedEmail ? <Check size={12} className="text-teal-600 dark:text-teal-400" /> : <Copy size={12} />}
          ...
          <div className="flex items-center justify-between p-3.5 rounded-xl bg-zinc-50 dark:bg-zinc-900/60 border border-zinc-200 dark:border-zinc-800 hover:border-teal-400 dark:hover:border-teal-600 hover:bg-teal-50/20 dark:hover:bg-teal-950/20 transition-all shadow-2xs">
            ...
            <button
              ...
              className="px-3 py-1 rounded-md bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 hover:border-teal-500 hover:text-teal-700 dark:hover:text-teal-300 text-zinc-700 dark:text-zinc-300 transition-all flex items-center gap-1 text-[11px] shadow-2xs font-semibold"
            >
              {copiedPhone ? <Check size={12} className="text-teal-600 dark:text-teal-400" /> : <Copy size={12} />}
      ...
      <div className="md:col-span-5 bento-card rounded-2xl p-6 sm:p-8 flex flex-col justify-between space-y-6">
        <div>
          ...
          <div className="mt-4 space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-xs text-zinc-600 dark:text-zinc-300 font-medium pl-6">
                Computer Engineering
              </p>
              <p className="text-[11px] text-zinc-500 dark:text-zinc-400 font-mono pl-6">
            ...
            <div className="space-y-1 pt-3 border-t border-zinc-200 dark:border-zinc-800">
              <div className="flex items-center gap-2 text-xs font-bold text-zinc-950 dark:text-white">
                <MapPin size={17} className="text-teal-600 dark:text-teal-400" />
                <span>Location</span>
              </div>
              <div className="text-xs text-zinc-700 dark:text-zinc-300 font-medium pl-6">
                <EditableText
        ...
        <div className="pt-3 border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between text-xs font-mono text-zinc-500 dark:text-zinc-400">
